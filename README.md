...
This package is a mirror of the streams implementations in Node.js 18.20.2.

Full documentation may be found on the [Node.js website](https://nodejs.org/dist/v18.20.2/docs/api/stream.html).
